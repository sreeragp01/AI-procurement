  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        {/* Notifications */}
        <div style={{ position: 'relative', cursor: 'pointer', padding: '0.45rem', borderRadius: '8px', background: '#F1F5F9', border: '1px solid #E2E8F0' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', borderLeft: '1px solid var(--border-color)', paddingLeft: '0.85rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.68rem', color: '#2563EB', fontWeight: 600 }}>{user.organization}</div>
          </div>
        </div>
      </div>
    </header>
